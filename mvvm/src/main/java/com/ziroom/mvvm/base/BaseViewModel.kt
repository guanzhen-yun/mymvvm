...
import com.ziroom.mvvm.event.SingleLiveEvent
 ...
 * viewmodel 基类
 */
open class BaseViewModel(application: Application = Utils.getApp()) : AndroidViewModel(application), LifecycleObserver {
    //委托模式 by lazy
    ...
    private suspend fun handleException(
        ...
        coroutineScope {
            try {
                ...
                error(MVVMManager.getConfig().globalExceptionHandle(e))
            } finally {
                complete()
            }
        }
